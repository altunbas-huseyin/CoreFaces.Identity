...
<head>
   ...
   <script>
        ...
        //var apiUrl = "http://localhost:56037/api/SystemAdmin/";
        var apiUrl = "http://identity.kuaforx.com/api/SystemAdmin/";
        var user = window.localStorage.getItem("apiUser");
        user = JSON.parse(user);
        
        //Üye ipine göre api url belirleniyor.
        /*
        if(user.parentId==="00000000-0000-0000-0000-000000000000")
        {
          apiUrl = apiUrl + "api/SystemAdmin/";
        }
        else
        {
            apiUrl = apiUrl + "api/AppAdmin/";
        }
        */
